...
- (void)populateMenu:(CMMenu *)menu withApplications:(NSArray *)runningApplications andSystemProcesses:(NSArray *)runningSystemProcesses {
    ...
    for (NSRunningApplication *app in runningApplications) {
        ...
        if ([_allApplicationsDict count]>0)
        {
            if ([_allApplicationsDict valueForKey:[app localizedName]])
            {
                currentLimit = [[_allApplicationsDict valueForKey:[app localizedName]] floatValue];
        ...
        NSMutableDictionary *appInfo = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                        ...
                                        [NSNumber numberWithFloat:currentLimit], APApplicationInfoLimitKey,
                                        nil];
        ...
        if ([_allApplicationsDict count]>0)
        {
            if ([_allApplicationsDict valueForKey:[app localizedName]])
            {
                NSLog(@"%f",[[_allApplicationsDict valueForKey:[app localizedName]] floatValue]);
                int proc_id =app.processIdentifier;
                currentLimit = [[_allApplicationsDict valueForKey:[app localizedName]] floatValue];
                proc_cpulim_set(proc_id,currentLimit);
                //	proc_cpulim_resume();
                ...
                [self processDidChange:userInfo];
...
- (void)appLaunchedNotificationHandler:(NSNotification *)notification {
    ...
    _allApplicationsDict = [[NSMutableDictionary alloc]init];
    _allApplicationsDict = [NSMutableDictionary dictionaryWithDictionary:[[NSUserDefaults standardUserDefaults] objectForKey:@"allApplicationsDict"]];
    if (_allApplicationsDict ==nil)
        _allApplicationsDict = [[NSMutableDictionary alloc]init];
    ...
    NSMutableDictionary *appInfo = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                    ...
                                    [NSNumber numberWithInt:[app processIdentifier]], APApplicationInfoPidKey,
                                    [NSNumber numberWithFloat:currentLimit], APApplicationInfoLimitKey, nil];
...
- (void)processDidChange:(NSDictionary *)userInfo {
